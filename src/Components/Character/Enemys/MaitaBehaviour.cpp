...
void bb::MaitaBehaviour::HandleTurning()
{
...
void bb::MaitaBehaviour::Update()
{
    ...
    const bool hasPlatformAbove = Physics::RayCast(from, castDirection, bb::Maita::CLIMB_HEIGHT, layer::ALL_TILES);
